...
export const Clock = makeSafe(Lucide.Clock)
...
export const Trash2 = makeSafe(Lucide.Trash2)
...
export const RotateCw = makeSafe(Lucide.RotateCw)
export const Youtube = makeSafe(Lucide.Youtube)
